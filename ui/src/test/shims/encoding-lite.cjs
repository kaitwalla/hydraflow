...
var { isWellFormed: isWellFormed2, toWellFormed: toWellFormed2 } = String.prototype;
var to8 = (a) => new Uint8Array(a.buffer, a.byteOffset, a.byteLength);
function encode2(str, loose = false, format = "uint16") {
  if (typeof str !== "string") throw new TypeError(E_STRING);
  if (format !== "uint16" && format !== "uint8-le" && format !== "uint8-be") {
    throw new TypeError("Unknown format");
  }
  ...
  } else if (!isWellFormed2.call(str)) {
...
function decodeNode(input, loose = false, format = "uint16") {
  ...
  if (isWellFormed2.call(str)) return str;
  throw new TypeError(E_STRICT);
}
var decode2 = isDeno ? decodeApiDecoders : decodeNode;
var utf16fromString = (str, format = "uint16") => encode2(str, false, format);
var utf16fromStringLoose = (str, format = "uint16") => encode2(str, true, format);
var utf16toString = (arr, format = "uint16") => decode2(arr, false, format);
var utf16toStringLoose = (arr, format = "uint16") => decode2(arr, true, format);
...
function typedView(arr, format) {
  ...
  switch (format) {
    ...
    case "buffer":
      if (arr.constructor === Buffer4 && Buffer4.isBuffer(arr)) return arr;
      return Buffer4.from(arr.buffer, arr.byteOffset, arr.byteLength);
  }
...
function decodeFast(arr, loose) {
  ...
  if (shouldUseEscapePath && escape && decodeURIComponent) {
    ...
    try {
      ...
      if (!loose) throw new TypeError(E_STRICT2);
    }
  }
  return prefix + decode3(arr, loose, prefix.length);
}
function decode3(arr, loose, start = 0) {
  start |= 0;
...
function encode4(str, loose = false) {
  ...
  if (!isWellFormed3.call(str)) throw new TypeError(E_STRICT_UNICODE);
  return res;
}
function decode4(arr, loose = false) {
  assertU8(arr);
...
var utf8fromString = (str, format = "uint8") => typedView(encode4(str, false), format);
var utf8fromStringLoose = (str, format = "uint8") => typedView(encode4(str, true), format);
var utf8toString = (arr) => decode4(arr, false);
var utf8toStringLoose = (arr) => decode4(arr, true);
...
function createSinglebyteEncoder(encoding, { mode = "fatal" } = {}) {
  ...
  return (s) => {
    ...
    const res = encode5(s, m);
    if (!res) throw new TypeError(E_STRICT3);
    return res;
  };
}
